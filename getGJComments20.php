...
for ($x = 0; $x < 9; $x++) {
	...
	$time = $comment1["timestamp"];
	$stringTime = convertTime($time);
	
	echo "2~".$comment1["comment"]."~3~".$comment1["userID"]."~4~".$comment1["likes"]."~5~0~7~0~9~".$stringTime."~6~".$comment1["commentID"];
...
if(is_numeric($userID)){
	...
	echo "#".$levelsstring;
	echo "#".count($result12).":".$commentpage.":10";
?>